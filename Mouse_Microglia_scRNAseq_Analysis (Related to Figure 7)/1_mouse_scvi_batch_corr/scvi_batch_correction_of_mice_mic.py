###############################################################################|
# Pipeline for correcting batch effects across mice microglia samples 
#                     for each sex using a scVI model
...
# Batch correct for Male data
input_data_path = 'data/h5ad/'
output_data_path  = 'scvi_output_downsampled_M_mouse_LogNormalize/'

# Load data-----
adata = sc.read_h5ad(os.path.join(input_data_path, 'downsampled_M_mouse_LogNormalize.h5ad'))
adata.layers["counts"] = adata.X.copy() # copy raw count 
adata = scvi_batch_correct_pipeline(adata, n_top_genes = 3000, batch_key = "orig.ident", seed = 888,n_layers = 2, n_latent =30, model_init = None, outdir = output_data_path, save = True)

# # Batch correct for Female data
# 
# input_data_path = 'data/h5ad/'
# output_data_path  = 'scvi_output_downsampled_F_mouse_LogNormalize/'
# 
# # Load data-----
# adata = sc.read_h5ad(os.path.join(input_data_path, 'downsampled_F_mouse_LogNormalize.h5ad'))
